...
[block="<?php $this->displayAttr($book->year) ?>"]
  [__tag="div" class="hCite book"]
    [__tag="cite" class="title"][url="<?php $this->displayAttr($book->url) ?>"]<?php $this->display($book->title) ?>[/url][/__tag]<?php $this->display($book->details) ?>
  [/__tag]
  [list]
