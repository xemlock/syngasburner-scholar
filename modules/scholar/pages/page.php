 ...
 * @return string
 */
function scholar_pages_page_list() // {{{
{
    ...
    return $help . theme_scholar_table($header, $rows);
} // }}}
 ...
 * @return array
 */
function scholar_pages_page_form(&$form_state, $id) // {{{
{
 ...
 * @param array &$form_state
 */
function scholar_pages_page_form_submit($form, &$form_state) // {{{
{
