{
    ...
    "Listy": {
        "*": {
            "syn" : "[*] element",
            "desc": "Jednolinijkowy element listy",
        ...
        "item": {
            ...
            "desc": "Element listy (jedno- lub wielolinijkowy)",
        ...
        "list=A": {
            ...
            "attrs": {
                "start": {"optional": true, "default": 1, "desc": "początek numeracji (1 odpowiada 'A', 2 &ndash; 'B', etc.)"},
            },
        },
        "list=a": {
            "syn" : "[list=a]\nelementy_listy\n[/list]",
            ...
            "attrs": {
                "start": {"optional": true, "default": 1, "desc": "ppoczątek numeracji (1 odpowiada 'a', 2 &ndash; 'b', etc.)"},
            },
        },
        "list=I": {
            "syn" : "[list=I]\nelementy_listy\n[/list]",
            ...
            "attrs": {
                "start": {"optional": true, "default": 1, "desc": "początek numeracji (1 odpowiada 'I', 2 &ndash; 'II', etc.)"},
            },
        },
        "list=i": {
            "syn" : "[list=i]\nelementy_listy\n[/list]",
